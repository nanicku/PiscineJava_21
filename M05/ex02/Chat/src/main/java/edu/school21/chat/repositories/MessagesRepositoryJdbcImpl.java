...
public class MessagesRepositoryJdbcImpl implements MessagesRepository {
    ...
    private static final String SQL_SELECT_BY_ID =
            "SELECT * , users.id as id, chatrooms.id as id_room " +
                    ...
                    "WHERE messages.id=?";
    private static final String SQL_INSERT_INTO_MESSAGE =
    ...
    public void save(Message message) throws SQLException {
        ...
        Connection connection = dataSource.getConnection();
        PreparedStatement prepareStatement = connection.prepareStatement(SQL_INSERT_INTO_MESSAGE, Statement.RETURN_GENERATED_KEYS);

        prepareStatement.setLong(1, message.getAuthor().getId());
        prepareStatement.setLong(2, message.getRoom().getId());
        prepareStatement.setString(3, message.getText());
        prepareStatement.setObject(4, message.getDate());
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                closeConnections(resultSet, prepareStatement, connection);
            }
        } catch (Exception ex) {
